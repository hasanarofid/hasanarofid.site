...
<head>
  ...
  <meta name="keywords"
    content="<?= $t['meta_keywords'] ?? 'fullstack engineer, web architecture, Laravel, Node.js, React, System Scaling, Enterprise Software' ?>" />
  ...
  <script>(function (w, d, s, l, i) {
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-58MBQBCL');</script>
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-58MBQBCL" height="0" width="0"
  ...
  <nav>
    <div class="container nav-content">
      <a href="#" class="logo">
        ...
        <span>Hasan Arofid <span class="logo-subtitle">|
            <?= $lang === 'id' ? 'Jasa Website' : 'Web Services' ?></span></span>
      </a>
      ...
      <div class="nav-links" id="navLinks">
        ...
        <a href="https://wa.me/628814959247"
          class="btn btn-primary btn-nav"><?= $lang === 'id' ? 'Hubungi Kami' : 'Contact Us' ?></a>
      </div>
      ...
      <div class="hero-grid">
        <div class="hero-content" data-reveal>
          ...
          <div class="hero-actions">
            <a href="https://wa.me/628814959247?text=Halo%20Hasan,%20saya%20ingin%20konsultasi%20mengenai%20pembuatan%20website"
              class="btn btn-primary" target="_blank"><?= $t['cta_book'] ?></a>
  ...
  <div class="trust-bar">
    <div class="container">
      <div class="trust-title">
        <?= $lang === 'id' ? 'Dipercaya oleh Bisnis & Industri Terkemuka' : 'Trusted by Leading Businesses & Industries' ?>
      </div>
      ...
      <div class="process-grid">
        <div class="process-item" data-reveal>
          ...
          <p style="font-size: 0.9rem; color: var(--text-muted); margin-top: 8px;">
            <?= $lang === 'id' ? 'Diskusi mendalam untuk memahami visi dan target bisnis Anda.' : 'Deep discussion to understand your business vision and targets.' ?>
          </p>
        </div>
        <div class="process-item" data-reveal data-delay="100">
          ...
          <p style="font-size: 0.9rem; color: var(--text-muted); margin-top: 8px;">
            <?= $lang === 'id' ? 'Perancangan UI/UX yang fokus pada pengalaman pengguna dan konversi.' : 'UI/UX design focused on user experience and conversion.' ?>
          </p>
        </div>
        <div class="process-item" data-reveal data-delay="200">
          ...
          <p style="font-size: 0.9rem; color: var(--text-muted); margin-top: 8px;">
            <?= $lang === 'id' ? 'Pengembangan sistem yang cepat, aman, dan mudah dikelola.' : 'Fast, secure, and easy-to-manage system development.' ?>
          </p>
        </div>
        <div class="process-item" data-reveal data-delay="300">
          ...
          <p style="font-size: 0.9rem; color: var(--text-muted); margin-top: 8px;">
            <?= $lang === 'id' ? 'Website live dan siap membantu pertumbuhan bisnis Anda.' : 'Website live and ready to help your business grow.' ?>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="exp-grid">
        <div class="exp-card" data-reveal>
          ...
          <a href="https://wa.me/628814959247?text=Halo%20Hasan,%20saya%20tertarik%20dengan%20paket%20Landing%20Page"
            class="btn btn-outline"
            style="margin-top: 24px; width: 100%; justify-content: center;"><?= $lang === 'id' ? 'Pelajari Selengkapnya' : 'Learn More' ?></a>
        </div>
        <div class="exp-card" data-reveal data-delay="100">
          <span class="exp-icon">🏢</span>
          <h3><?= $t['exp_api'] ?></h3>
          <p><?= $t['exp_api_desc'] ?></p>
          <a href="https://wa.me/628814959247?text=Halo%20Hasan,%20saya%20tertarik%20dengan%20paket%20Company%20Profile"
            class="btn btn-outline"
            style="margin-top: 24px; width: 100%; justify-content: center;"><?= $lang === 'id' ? 'Pelajari Selengkapnya' : 'Learn More' ?></a>
        </div>
        <div class="exp-card" data-reveal data-delay="200">
          ...
          <a href="https://wa.me/628814959247?text=Halo%20Hasan,%20saya%20tertarik%20dengan%20sistem%20Web%20Custom"
            class="btn btn-outline"
            style="margin-top: 24px; width: 100%; justify-content: center;"><?= $lang === 'id' ? 'Pelajari Selengkapnya' : 'Learn More' ?></a>
        </div>
        <div class="exp-card" data-reveal data-delay="300">
          ...
          <a href="https://wa.me/628814959247?text=Halo%20Hasan,%20saya%20tertarik%20dengan%20solusi%20E-Commerce"
            class="btn btn-outline"
            style="margin-top: 24px; width: 100%; justify-content: center;"><?= $lang === 'id' ? 'Pelajari Selengkapnya' : 'Learn More' ?></a>
        </div>
      </div>
      ...
      <div class="projects-grid">
        <div class="project-card" data-reveal onclick="window.open('https://amtechev.com/', '_blank')">
          ...
          <div class="project-content">
            ...
            <p>Built a unified management system for Malaysia's leading EV network. Handling real-time hardware
              telemetry and multi-tenant billing.</p>
            <div style="margin-top: 16px; font-weight: 600; color: var(--accent);"><?= $t['project_impact'] ?>: 100%
              Automated Billing & Monitoring</div>
          </div>
        </div>
        <div class="project-card" data-reveal data-delay="100">
          ...
          <div class="project-content">
            ...
            <div style="margin-top: 16px; font-weight: 600; color: var(--accent);"><?= $t['project_impact'] ?>: 40%
              Operational Efficiency Increase</div>
          </div>
        </div>
        ...
        <div class="project-card" data-reveal data-delay="200">
          ...
          <div class="project-content">
            ...
            <p>Integrated catering management and point-of-sale system. Streamlining order processing and inventory
              tracking.</p>
            <div style="margin-top: 16px; font-weight: 600; color: var(--accent);"><?= $t['project_impact'] ?>:
              Optimized Order Lifecycle</div>
          </div>
        </div>
        ...
        <div class="projects-grid">
          <?php foreach ($latestProducts as $p): ?>
            <div class="project-card" data-reveal>
              <?php if ($p['image_url']): ?>
                <img src="<?= htmlspecialchars($p['image_url']) ?>" class="project-img"
                  alt="<?= htmlspecialchars($p['name']) ?>">
              <?php else: ?>
                <div class="project-img"
                  style="display: flex; align-items: center; justify-content: center; font-size: 3rem; background: var(--surface-hover);">
                  📦</div>
              <?php endif; ?>
              <div class="project-content">
                ...
                <div style="margin-top: 16px; display: flex; justify-content: space-between; align-items: center;">
                  ...
                  <a href="<?= htmlspecialchars($p['link']) ?>" target="_blank"
                    style="color: var(--text); text-decoration: none; font-weight: 600; font-size: 0.9rem;"><?= $lang === 'id' ? 'Beli Sekarang' : 'Buy Now' ?>
                    →</a>
                </div>
              </div>
            </div>
    ...
    <div class="container">
      ...
      <div class="testi-grid">
        <div class="testi-card" data-reveal>
          <p class="testi-quote">
            <?= $lang === 'id' ? 'Sistem infrastruktur yang dibangun Hasan sangat stabil. Operasional jaringan EV kami di Malaysia menjadi 100% otomatis dan sangat efisien.' : 'The infrastructure system built by Hasan is incredibly stable. Our EV network operations in Malaysia are now 100% automated and highly efficient.' ?>
          </p>
        ...
        <div class="testi-card" data-reveal data-delay="100">
          <p class="testi-quote">
            <?= $lang === 'id' ? 'Manajemen pesanan kami sekarang jauh lebih cepat dan terintegrasi. Penjualan meningkat karena website sangat mudah digunakan oleh pelanggan.' : 'Our order management is now much faster and integrated. Sales increased because the website is so easy for customers to use.' ?>
          </p>
          <div class="testi-author">
        ...
        <div class="testi-card" data-reveal data-delay="200">
          <p class="testi-quote">
            <?= $lang === 'id' ? 'Solusi digital yang diberikan benar-benar menjawab masalah operasional kami. Sistem pengawasan sekolah kami menjadi jauh lebih transparan.' : 'The digital solution provided truly addressed our operational challenges. Our school oversight system has become much more transparent.' ?>
          </p>
          <div class="testi-author">
  ...
  <section id="contact">
    <div class="container" style="max-width: 700px;">
      <div class="section-title" data-reveal><?= $lang === 'id' ? 'Dapatkan Penawaran Gratis' : 'Get a Free Quote' ?>
      </div>
      <div class="section-subtitle" data-reveal>
        <?= $lang === 'id' ? 'Siap memulai proyek Anda? Beritahu kami kebutuhan Anda.' : 'Ready to start your project? Tell us your needs.' ?>
      </div>
      <form id="dev-request-form" style="display: grid; gap: 20px; margin-top: 48px;">
        <div class="contact-form-grid">
          <input type="text" name="name" placeholder="<?= $lang === 'id' ? 'Nama' : 'Name' ?>" required
            class="form-input">
          <input type="email" name="email" placeholder="Email" required class="form-input">
        </div>
        <textarea name="description"
          placeholder="<?= $lang === 'id' ? 'Ceritakan tantangan teknis Anda...' : 'Tell me about your technical challenge...' ?>"
          rows="6" required class="form-input"></textarea>
        <input type="hidden" name="service" value="web-development-service">
        <button type="submit" class="btn btn-primary"
          style="justify-content: center; font-size: 1.1rem; width: 100%;"><?= $lang === 'id' ? 'Kirim Pesan Strategis' : 'Send Strategic Message' ?></button>
      </form>
    ...
    <section id="blog" style="background: rgba(0,0,0,0.01);">
      <div class="container">
        <div class="section-title" data-reveal>
          <?= $lang === 'id' ? 'Wawasan & Strategi Digital' : 'Insights & Digital Strategy' ?>
        </div>
        <div class="section-subtitle" data-reveal>
          <?= $lang === 'id' ? 'Artikel terbaru untuk membantu Anda memahami tren teknologi dan strategi pertumbuhan bisnis online.' : 'Latest articles to help you understand tech trends and online business growth strategies.' ?>
        </div>
        ...
        <div class="article-grid">
          <?php foreach ($latestArticles as $a): ?>
            <a href="blog.php?slug=<?= $a['slug'] ?>" class="article-card" data-reveal>
              ...
              <span class="article-link"><?= $lang === 'id' ? 'Baca Selengkapnya' : 'Read Full Article' ?>
                <span>→</span></span>
            </a>
          <?php endforeach; ?>
        </div>
    ...
    <div class="container">
      ...
      <div style="margin: 20px 0; display: flex; justify-content: center; gap: 24px; font-size: 0.9rem;">
        <a href="privacy-policy.php"
          style="color: var(--text-muted); text-decoration: none;"><?= $lang === 'id' ? 'Kebijakan Privasi' : 'Privacy Policy' ?></a>
        <a href="terms-of-service.php"
          style="color: var(--text-muted); text-decoration: none;"><?= $lang === 'id' ? 'Syarat & Ketentuan' : 'Terms of Service' ?></a>
        <a href="contact.php"
          style="color: var(--text-muted); text-decoration: none;"><?= $lang === 'id' ? 'Kontak' : 'Contact' ?></a>
      </div>
